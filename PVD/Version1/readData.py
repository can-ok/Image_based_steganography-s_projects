...
def read_binary(img_data):
    ...
    encrypted_data=piksel_frame[size-1] #LSB
    encrypted_data2=piksel_frame[size-2] #lSB+2nd
  
    index=index+1
    return encrypted_data,encrypted_data2
...
for i in range(0,rnd):
    ...
    #print(img[i][y])
    #print(data)
    encrypted_data,encrypted_data2=read_binary(data)
    msg.append(encrypted_data)
    msg.append(encrypted_data2)
